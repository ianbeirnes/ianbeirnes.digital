...
window.ASTEROIDSPLAYERS[window.ASTEROIDSPLAYERS.length]=new Asteroids();}};script.src="./js/excanvas.js";document.getElementsByTagName('head')[0].appendChild(script);}
